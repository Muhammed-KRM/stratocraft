...
public class BreedingManager {
    ...
    public static class BreedingFacility {
        ...
        public LivingEntity getFemale() {
            return female;
        }

        public LivingEntity getMale() {
            return male;
        }

        public void setFemale(LivingEntity female) {
            this.female = female;
        }

        public void setMale(LivingEntity male) {
            this.male = male;
        }
    ...
    private LivingEntity spawnCreatureByType(String parentName, Location loc) {
        ...
        if (name.contains("ORK")) {
            org.bukkit.entity.Zombie ork = (org.bukkit.entity.Zombie) loc.getWorld().spawnEntity(loc,
                    EntityType.ZOMBIE);
            ...
            org.bukkit.entity.Zombie goblin = (org.bukkit.entity.Zombie) loc.getWorld().spawnEntity(loc,
                    EntityType.ZOMBIE);
            ...
            org.bukkit.entity.Zombie troll = (org.bukkit.entity.Zombie) loc.getWorld().spawnEntity(loc,
                    EntityType.ZOMBIE);
            ...
            org.bukkit.entity.Zombie minotaur = (org.bukkit.entity.Zombie) loc.getWorld().spawnEntity(loc,
                    EntityType.ZOMBIE);
        ...
        // Varsayılan: Zombie
        org.bukkit.entity.Zombie defaultMob = (org.bukkit.entity.Zombie) loc.getWorld().spawnEntity(loc,
                EntityType.ZOMBIE);
                ...
                if (parent != null && !parent.isDead()) {
                    ...
                    if (eggName != null) {
                        ...
                        if (defaultOffspring != null) {
                            int difficultyLevel = plugin.getDifficultyManager()
                                    .getDifficultyLevel(turtle.getLocation());
