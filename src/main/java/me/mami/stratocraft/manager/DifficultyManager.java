...
public class DifficultyManager {
    ...
    public boolean canSpawnMobAtLevel(int level, String mobName) {
        switch (mobName.toLowerCase()) {
            ...
            // Seviye 2 (200-1000 blok): Ork, Troll, SkeletonKnight, DarkMage, Werewolf, GiantSpider, Minotaur, Harpy, Basilisk
            case "ork":
            case "troll":
            ...
            // Seviye 3 (1000-3000 blok): T-Rex, Cyclops, Griffin, Wraith, Lich, Kraken, Phoenix, Behemoth
            case "trex":
            case "t_rex":
            case "cyclops":
            case "griffin":
            ...
            // Seviye 4 (3000-5000 blok): Dragon, Wyvern, HellDragon, TerrorWorm, WarBear, ShadowPanther
            case "dragon":
            case "ejderha":
            case "wyvern":
            case "hell_dragon":
    ...
    // Getter'lar
    public int getLevel1Distance() { return level1Distance; }
    public int getLevel2Distance() { return level2Distance; }
    public int getLevel3Distance() { return level3Distance; }
    public int getLevel4Distance() { return level4Distance; }
    public int getLevel5Distance() { return level5Distance; }
}
