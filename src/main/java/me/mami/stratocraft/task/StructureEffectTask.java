...
public class StructureEffectTask extends BukkitRunnable {
    ...
    public void run() {
        ...
        for (Clan clan : clanManager.getAllClans()) {
            for (Structure structure : clan.getStructures()) {
                applyStructureEffect(clan, structure);
            }
        }
    }

    /**
     * Yapı tipine göre efekt uygula
     */
    private void applyStructureEffect(Clan clan, Structure structure) {
        ...
        switch (type) {
            ...
            case HEALING_BEACON:
                ...
                break;
            case AUTO_TURRET:
                // Auto Turret efekti ayrı bir sistem (SiegeWeaponManager)
                break;
            ...
            // Diğer yapılar...
            default:
                // Pasif yapılar veya henüz implement edilmemiş
                break;
        }
    }
     ...
     * (Bu efekt BatteryManager'da uygulanıyor, burada sadece partiküller)
     */
